...
export default function ProgressColumn({ progressTaskData }) {
  const progressData = [...progressTaskData];
  return (
    <>
      <div className="flex-1 flex flex-col min-w-0 w-full">
        <TaskHeader columnName="In Progress" />
            ...
            >
              ...
              <div className="flex items-center gap-2 mb-3">
                <span
                  ...
                  className="inline-block px-2.5 py-1 bg-purple-50  text-xs font-medium rounded"
                >
                  {item.tag}
                </span>
              </div>
